...
const entities = [
    ...
    // === ASSIGNMENTS ===
    {
        ...
        attributes: [
            ...
            { name: "description", type: "Text", required: true, desc: "Описание задания" },
            ...
            { name: "submission_type", type: "Array/JSON", required: false, desc: "text / file / url / none" },
    ...
    // === SCHEDULES ===
    {
        ...
        attributes: [
            ...
            { name: "start_condition", type: "Enum", required: true, desc: "course_start / prev_complete / manual" },
